package net.pulga22.minigamecore.core.config;

import net.pulga22.minigamecore.core.teams.CustomTeam;
...
public class ConfigManager<T extends Plugin> {
    ...
    public static <P extends Plugin> ConfigManager<P> register(P plugin){
     ...
     */
    protected void tryLoad(String file, BiConsumer<File, FileConfiguration> onNew, BiConsumer<File, FileConfiguration> onLoaded, Consumer<Exception> onException){
     ...
     * @param onLoaded Actions taken when the file already exists.
     */
    protected void tryLoad(String file, BiConsumer<File, FileConfiguration> onNew, BiConsumer<File, FileConfiguration> onLoaded){
