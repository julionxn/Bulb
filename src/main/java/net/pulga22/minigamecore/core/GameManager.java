...
import net.pulga22.minigamecore.core.functional.GameInstanceListener;
import net.pulga22.minigamecore.core.functional.ICreateGameInstance;
import net.pulga22.minigamecore.core.functional.IGameInstanceListener;
...
import net.pulga22.minigamecore.util.PluginUtils;
...
public class GameManager<T extends GameInstance<K>, K extends Plugin> {
    ...
    public static <G extends GameInstance<P>, P extends Plugin> GameManager<G, P> register(P plugin, ConfigManager<P> configManager, String gameName, ICreateGameInstance<G, P> gameInstance, GameScoreboardInfo info){
    ...
    public static <G extends GameInstance<P>, P extends Plugin> GameManager<G, P> register(P plugin, ConfigManager<P> configManager, String gameName, ICreateGameInstance<G, P> gameInstance){
        HashSet<WorldOption> worlds = configManager.getWorldsOfGame(gameName);
        if (worlds == null || worlds.isEmpty()){
            throw new RuntimeException("No worlds of " + gameName + " founded.");
        }
        return new GameManager<>(plugin, configManager, gameName, gameInstance, GameScoreboardInfo.ofEmpty());
    }
